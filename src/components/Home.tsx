  ...
  useEffect(() => {
    ...
    const playAudio = () => {
      audio.play().then(() => {
        ...
        console.log('Autoplay blocked initially, listening for interaction...', err);
      });
    };

    // Attempt to start playing immediately in the background
    playAudio();

    // Fallback listeners for robust autoplay activation on user interaction
